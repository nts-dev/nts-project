<?php
	// General
	$moxieManagerConfig['general.license'] = 'IVD7-NIGP-GLCB-GCP7-GRAQ-FJW7-PPCQ-OHXE';
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = '../../../../../userfiles/image';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "admin", "password" => "admin1234", "groups" => array("administrator"))
	);
